...
void ExpressionPresets::scanAll(const bool &clear)
{
    ...
    expressions << ":/expressions/noise.fexpr";
    expressions << ":/expressions/oscillation.fexpr";
    expressions << ":/expressions/time.fexpr";
    expressions << ":/expressions/wave.fexpr";
    expressions << ":/expressions/wiggle.fexpr";
    expressions << ":/expressions/blink.fexpr";
    expressions << ":/expressions/bounceLoop.fexpr";
    expressions << ":/expressions/breathe.fexpr";
    expressions << ":/expressions/drift.fexpr";
    expressions << ":/expressions/fadeInOut.fexpr";
    expressions << ":/expressions/pingPong.fexpr";
    expressions << ":/expressions/pulse.fexpr";
    expressions << ":/expressions/rotation.fexpr";
    expressions << ":/expressions/copyX.fexpr";
    expressions << ":/expressions/copyY.fexpr";
    expressions << ":/expressions/orbitX.fexpr";
    expressions << ":/expressions/orbitY.fexpr";
    expressions << ":/expressions/trackObject.fexpr";
    expressions << ":/expressions/loopout.fexpr";
    expressions << ":/expressions/loopin.fexpr";
    expressions << ":/expressions/linear.fexpr";
    expressions << ":/expressions/ease.fexpr";
