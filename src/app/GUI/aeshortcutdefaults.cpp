...
QList<AeShortcutDefinition> aeShortcutDefinitions()
{
    return {
        ...
        {QStringLiteral("pathCreate"), QStringLiteral("Tools"), QObject::tr("Pen Tool"), QObject::tr("AE-style pen tool. Click to create/extend a path, click a segment to add a vertex, Alt-click a point to delete a vertex."), QStringLiteral("P")},
        {QStringLiteral("drawPath"), QStringLiteral("Tools"), QObject::tr("Freehand Path Tool"), QObject::tr("Freehand drawing / fitting tool. Kept as a secondary path creation mode."), QStringLiteral("Shift+P")},
