...
public:
    ...
    void setMarker();
    void splitClip();
    bool moveSelectedLayerInToCurrentFrame();
    bool moveSelectedLayerOutToCurrentFrame();
    bool trimSelectedLayersBeforeCurrentFrame();
    bool trimSelectedLayersAfterCurrentFrame();
    bool shiftCurrentFrameBy(int delta);
    bool toggleSelectedTimeRemapping();
    bool freezeSelectedFramesAtCurrentTime();

    TimelineWidget *currentTimelineWidget() const;
