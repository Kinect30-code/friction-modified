    ...
    : Friction::Ui::Dialog(parent)
{
    ...
    twoColLayout->addPair(new QLabel(tr("Composition")), sceneButton);
    ...
    mImageFormat->setToolTip(tr("Image format used for raster elements (images/videos) contained in the composition"));
    ...
    // layout
    const auto sceneWidget = new QGroupBox(tr("Composition"), this);
