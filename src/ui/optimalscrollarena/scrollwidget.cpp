...
void ScrollWidget::setViewMode(const SWT_ViewMode mode) {
    mVisiblePartWidget->setViewMode(mode);
}

void ScrollWidget::setAlwaysShowChildren(const bool alwaysShowChildren) {
    mVisiblePartWidget->setAlwaysShowChildren(alwaysShowChildren);
}
